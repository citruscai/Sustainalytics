...
import { wasteDataByYear } from '../data/AUemissionsdata'; 

const AustralianWasteData: React.FC = () => {
  ...
  return (
    <div>
      <h1 className="text-center mb-6">ConocoPhillips Australia Waste Metrics</h1>
...
export default AustralianWasteData;
